									...
									else
									{
										...
										else
										{
											...
											else
											{
												...
												if($AW1=="men")
												{
													if(substr($masukan,3,1)=="a" || substr($masukan,3,1)=="e" || substr($masukan,3,1)=="i" || substr($masukan,3,1)=="o" || substr($masukan,3,1)=="u")
													{
							...
							else
							{
								...
								if($AW1=="pe")
								{
									...
									if($AW1=="pen")
									{
										...
										if($AW1=="peng")
										{
											if(substr($masukan,4,1)=="a" || substr($masukan,4,1)=="e" || substr($masukan,4,1)=="i" || substr($masukan,4,1)=="o" || substr($masukan,4,1)=="u")
											{
												$keluaran = "k".substr($masukan,4,strlen($masukan));
											}
											else
											{
												$keluaran = $masukan;
										...
										if(substr($masukan,3,1)=="a" || substr($masukan,3,1)=="e" || substr($masukan,3,1)=="i" || substr($masukan,3,1)=="o" || substr($masukan,3,1)=="u")
										{
											$keluaran = "p".substr($masukan,3,strlen($masukan));
										}
										else
										{
											$keluaran = substr($masukan,3,strlen($masukan));
										...
										if(substr($masukan,3,1)=="a")
										{
											$keluaran = "r".substr($masukan,3,strlen($masukan));
										}
										else
										{
											$keluaran = substr($masukan,3,strlen($masukan));
