...
include 'config.php';
define("HOSTNAME_DB", $database['hostname']);
define("USERNAME_DB", $database['username']);
define("PASSWORD_DB", $database['password']);
define("DATABASE_DB", $database['database']);
...
class Preprocessing
{
    ...
    */
    ...
    function cari($kata){
        ...
        $katadasar = isset($row['katadasar']) ? $row['katadasar'] : NULL;
        return $katadasar;
    }
